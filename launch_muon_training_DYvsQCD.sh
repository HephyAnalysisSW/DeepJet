...
trainingDataTxtFile='/local/gmoertl/DeepLepton/TrainingData/v4/step3/2016/muo/pt_15_-1/DYvsQCD/train_muo.txt'    #txt file should contain all training files, files should be stored in the same directroy as the txt file
...
EvaluationTestDataTxtFile='/local/gmoertl/DeepLepton/TrainingData/v4/step3/2016/muo/pt_15_-1/DYvsQCD/test_muo.txt' 
EvaluationTrainDataTxtFile='/local/gmoertl/DeepLepton/TrainingData/v4/step3/2016/muo/pt_15_-1/DYvsQCD/train_muo.txt'  
