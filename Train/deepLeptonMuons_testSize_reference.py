...
if newtraining:
    from models import model_deepLeptonReference_testSize
    
    train.setModel(model_deepLeptonReference_testSize,dropoutRate=0.5,momentum=0.2)
    ...
    model,history = train.trainModel(nepochs=50, #3, #4 
