...
#1) Preperation:
convertFromRoot.py -i /local/gmoertl/DeepLepton/TrainingData/${version}/step3/${year}/${short}/${ptSelection}/${sampleSelection}/${sampleSize}train_${short}.txt -o /local/gmoertl/DeepLepton/DeepJet_GPU/DeepJetResults/${sampleSelection}_${prefix}${flavour}${run}TrainData -c TrainData_deepLeptons_${flavour}s${sorted}_${year}${simple}
