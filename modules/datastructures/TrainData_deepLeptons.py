...
class TrainData_deepLeptons_Electrons_2016(TrainData_fullTruth):
    ...
    def __init__(self):
        ...
        'lep_etaSc', 'lep_sigmaIEtaIEta', 'lep_full5x5_sigmaIetaIeta', 'lep_dEtaInSeed', 'lep_dPhiScTrkIn', 'lep_dEtaScTrkIn', 'lep_eInvMinusPInv', 'lep_convVeto_float', 'lep_hadronicOverEm', 'lep_r9', 'lep_mvaIdSpring16',
        ...
        'lep_relIso03', 'lep_lostHits_float', 'lep_innerTrackValidHitFraction', 'lep_miniRelIsoCharged', 'lep_miniRelIsoNeutral',
        'lep_jetDR', 'lep_dxy', 'lep_dz', 'lep_edxy', 'lep_edz', 'lep_ip3d', 'lep_sip3d', #'lep_EffectiveArea03', 'lep_relIso04',
        ...
        #'lep_jetBTagCSV', 
        'lep_jetBTagDeepCSV', #'lep_jetBTagDeepCSVCvsB', 'lep_jetBTagDeepCSVCvsL',  
        ])

        #add realtive pt and deltaR for pf!
        self.addBranches(['pfCand_neutral_pt',  'pfCand_neutral_ptRel',  'pfCand_neutral_deltaR',  'pfCand_neutral_dxy_pf',  'pfCand_neutral_dz_pf', 'pfCand_neutral_puppiWeight', 'pfCand_neutral_hcalFraction', 'pfCand_neutral_fromPV', 'pfCand_neutral_dzAssociatedPV'],15)
        self.addBranches(['pfCand_charged_pt',  'pfCand_charged_ptRel',  'pfCand_charged_deltaR',  'pfCand_charged_dxy_pf',  'pfCand_charged_dz_pf', 'pfCand_charged_puppiWeight', 'pfCand_charged_hcalFraction', 'pfCand_charged_fromPV', 'pfCand_charged_dzAssociatedPV'],60)
        self.addBranches(['pfCand_photon_pt',   'pfCand_photon_ptRel',   'pfCand_photon_deltaR',   'pfCand_photon_dxy_pf',   'pfCand_photon_dz_pf',  'pfCand_photon_puppiWeight',  'pfCand_photon_hcalFraction',  'pfCand_photon_fromPV',  'pfCand_photon_dzAssociatedPV' ],35)
        self.addBranches(['pfCand_electron_pt', 'pfCand_electron_ptRel', 'pfCand_electron_deltaR', 'pfCand_electron_dxy_pf', 'pfCand_electron_dz_pf'],10)
        self.addBranches(['pfCand_muon_pt',     'pfCand_muon_ptRel',     'pfCand_muon_deltaR',     'pfCand_muon_dxy_pf',     'pfCand_muon_dz_pf'    ],10)
        self.addBranches(['SV_pt', 'SV_chi2', 'SV_ndof', 'SV_dxy', 'SV_edxy', 'SV_ip3d', 'SV_eip3d', 'SV_sip3d', 'SV_cosTheta', 'SV_deltaR',
                          'SV_jetPt', 'SV_jetEta', 'SV_jetDR', 'SV_maxDxyTracks', 'SV_secDxyTracks', 'SV_maxD3dTracks', 'SV_secD3dTracks'],5)
...
class TrainData_deepLeptons_Muons_2016(TrainData_fullTruth):
    ...
    def __init__(self):
        ...
        self.addBranches(['pfCand_neutral_ptRel',  'pfCand_neutral_deltaR',  'pfCand_neutral_pt',  'pfCand_neutral_dxy_pf',  'pfCand_neutral_dz_pf', 'pfCand_neutral_puppiWeight', 'pfCand_neutral_hcalFraction', 'pfCand_neutral_fromPV'],12)
        self.addBranches(['pfCand_charged_ptRel',  'pfCand_charged_deltaR',  'pfCand_charged_pt',  'pfCand_charged_dxy_pf',  'pfCand_charged_dz_pf', 'pfCand_charged_puppiWeight', 'pfCand_charged_hcalFraction', 'pfCand_charged_fromPV'],60)
        self.addBranches(['pfCand_photon_ptRel',   'pfCand_photon_deltaR',   'pfCand_photon_pt',   'pfCand_photon_dxy_pf',   'pfCand_photon_dz_pf',  'pfCand_photon_puppiWeight',  'pfCand_photon_hcalFraction',  'pfCand_photon_fromPV' ],35)
        self.addBranches(['pfCand_electron_ptRel', 'pfCand_electron_deltaR', 'pfCand_electron_pt', 'pfCand_electron_dxy_pf', 'pfCand_electron_dz_pf'],6)
        self.addBranches(['pfCand_muon_ptRel',     'pfCand_muon_deltaR',     'pfCand_muon_pt',     'pfCand_muon_dxy_pf',     'pfCand_muon_dz_pf'    ],6)
        self.addBranches([ 'SV_pt', 'SV_chi2', 'SV_ndof', 'SV_dxy', 'SV_edxy', 'SV_ip3d', 'SV_eip3d', 'SV_sip3d', 'SV_cosTheta', 'SV_deltaR',
