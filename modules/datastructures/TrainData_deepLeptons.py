...
from TrainDataDeepLepton import TrainData_fullTruth, TrainData_fullTruth_simple, TrainData_fullTruth_nonPrompt
...
class TrainData_deepLeptons_Electrons_sorted_2016(TrainData_fullTruth):
    ...
    def __init__(self):
        ...
        self.addBranches(['pfCand_charged_ptRel_ptRelSorted',  'pfCand_charged_deltaR_ptRelSorted',  'pfCand_charged_pt_ptRelSorted',  'pfCand_charged_puppiWeight_ptRelSorted', 'pfCand_charged_fromPV_ptRelSorted', 'pfCand_charged_dxy_pf_ptRelSorted', 'pfCand_charged_dz_pf_ptRelSorted',],25)
...
class TrainData_deepLeptons_Muons_sorted_2016_nonPrompt(TrainData_fullTruth_nonPrompt):
    '''
    classdocs
    '''
    ...
    def __init__(self):
        ...
        Constructor
        '''
        TrainData_fullTruth_nonPrompt.__init__(self)
