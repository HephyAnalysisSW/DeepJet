...
#prefix='TTs_Muon_'
prefix='TTJets_Electron_biLSTM_split_' #produces error if not ending with '_'

#select training data and 
trainingDataTxtFile='/local/tbrueckler/DeepLepton/DeepJet_GPU/TrainingData/v1_v4/step3/2017/ele/pt_5_-1/TTJets/train_ele_2017.txt'    #txt file should contain all training files, files should be stored in the same directroy as the txt file
trainingOutputDirectory='/local/tbrueckler/DeepLepton/DeepJet_GPU/DeepJetResults/electron_2017'                              #training output directory must exist
trainingDataStructure='TrainData_deepLeptons_Electrons_2017_run1'                                             #select from DeepJet/modules/datastructures/TrainData_deepLeptons.py
trainingModelReference='Train/deepLepton_Electrons_biLSTM_split_reference.py'                                                 #select from DeepJet/Train/deepLeptonXYreference.py, where the training model can be defined, define architecture in DeepJet/modules/models/convolutional_deepLepton.py and layers in DeepJet/modules/models/buildingBlocks_deepLepton.py

#select evaluation data
EvaluationTestDataTxtFile='/local/tbrueckler/DeepLepton/DeepJet_GPU/TrainingData/v1_v4/step3/2017/ele/pt_5_-1/TTJets/test_ele_2017.txt' 
EvaluationTrainDataTxtFile='/local/tbrueckler/DeepLepton/DeepJet_GPU/TrainingData/v1_v4/step3/2017/ele/pt_5_-1/TTJets/50train_ele_2017.txt'  
