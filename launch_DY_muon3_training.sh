...
sampleSelection='DYVsQCD_ptRelSorted'
sorted='_ptRelSorted'
sampleSize='medium_'
prefix='Medium'
DNN=''
...
###1) Preperation:
#convertFromRoot.py -i /local/gmoertl/DeepLepton/TrainingData/v1/${year}/${short}/${ptSelection}/${sampleSelection}/${sampleSize}train_${short}_std.txt -o /local/gmoertl/DeepLepton/DeepJet_GPU/DeepJetResults/${sampleSelection}_${prefix}${flavour}${run}TrainData -c TrainData_deepLeptons_${flavour}s${sorted}_${year}
...
##3) Evaluation:
##a) for test data
#convertFromRoot.py --testdatafor /local/gmoertl/DeepLepton/DeepJet_GPU/DeepJetResults/${sampleSelection}_${prefix}${flavour}${run}Training/trainsamples.dc -i /local/gmoertl/DeepLepton/TrainingData/v1/${year}/${short}/${ptSelection}/${sampleSelection}/${sampleSize}test_${short}_std.txt -o /local/gmoertl/DeepLepton/DeepJet_GPU/DeepJetResults/${sampleSelection}_${prefix}${flavour}${run}TestData
...
#b) for train data
convertFromRoot.py --testdatafor /local/gmoertl/DeepLepton/DeepJet_GPU/DeepJetResults/${sampleSelection}_${prefix}${flavour}${run}Training/trainsamples.dc -i /local/gmoertl/DeepLepton/TrainingData/v1/${year}/${short}/${ptSelection}/${sampleSelection}/${sampleSize}train_${short}_std.txt -o /local/gmoertl/DeepLepton/DeepJet_GPU/DeepJetResults/${sampleSelection}_${prefix}${flavour}${run}TestDataIsTrainData
