...
trainingDataTxtFile='/local/sschneider/DeepLepton/DeepJet_GPU/TrainingData/v1/step3/2016/ele/pt_5_-1/TTs/10train_ele.txt'    #txt file should contain all training files, files should be stored in the same directroy as the txt file
